...
RSpec.describe "Apartments", type: :request do
  before :all do
    ...
    Apartment.create(address: '11th Street', rent: '3820', reviews: 4.5, amenities: 'wifi, parking', deposit: '5800', sq_ft: '800', lease_length: '24 months', type_id: 1)
    Apartment.create(address: '234th Street', rent: '544', reviews: 4.6, amenities: 'wifi, parking, security', deposit: '5300', sq_ft: '300', lease_length: '34 months', type_id: 1)
  end
